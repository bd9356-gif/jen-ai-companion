...
// Independent version flag for the Meal Plan ⭐ To Make seed. Bump if we
// ever change which starter recipes get auto-added to Meal Plan. The seed
// itself filters by FAVORITE_STARTER_TITLES + the family_notes prefix
// (NOT by is_favorite), so it self-heals regardless of whether the
// is_favorite column was successfully written during the recipe seed.
// See seedMealPlanOnce in app/kitchen/page.js.
export const STARTER_MEAL_PLAN_VERSION = 'v1'
...
//   3. the Meal Plan seeder (matches by title list, not by is_favorite,
//      so it works even if the favorite write never landed)
//
