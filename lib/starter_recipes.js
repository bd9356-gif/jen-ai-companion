...
//   family_notes, photo_url
//
// family_notes = "A starter recipe — swap, edit, or delete anytime." marks them
// as app-seeded so users know these are examples, not personal saves.
...
export const STARTER_RECIPES = [
  {
    ...
    family_notes: 'A starter recipe — swap, edit, or delete anytime.',
    photo_url: '',
  },
...
export const STARTER_RECIPES_VERSION = 'v1'
