      ...
      <main className="max-w-2xl mx-auto px-4 py-8 space-y-6 text-gray-700">
        ...
        <section>
          ...
          <ul className="text-sm leading-relaxed space-y-2 list-disc pl-4">
            ...
            <li><strong>Google OAuth:</strong> Used for sign-in. Governed by Google privacy policy.</li>
            <li><strong>Anthropic Claude AI:</strong> Powers Chef Jen. Recipe queries are sent to Anthropic API.</li>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-2">Children Privacy</h2>
