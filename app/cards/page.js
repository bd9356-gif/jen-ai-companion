        ...
        <main className="max-w-lg mx-auto px-4 py-6 pb-16">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-5 mb-5">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs text-gray-400">— your version of the dish</span>
            </div>
            {cardPhoto ? (
              ...
              <button onClick={() => photoInputRef.current?.click()}
                ...
                <span className="text-xs text-gray-400">Your cooked version, holiday edition, or kids helping!</span>
              </button>
            )}
            <input ref={photoInputRef} type="file" accept="image/*" className="hidden"
              onChange={e => e.target.files?.[0] && uploadCardPhoto(e.target.files[0])} />
            {uploadingPhoto && <p className="text-xs text-center text-gray-400">Uploading...</p>}
          </div>
          ...
          <div className="bg-purple-50 border border-purple-100 rounded-2xl p-5 mb-5">
            ...
            {loadingSuggestions && (
              <div className="text-center py-4 text-gray-400 text-sm">Your chef is thinking...</div>
            )}
            {suggestions && (
    ...
    <div className="min-h-screen bg-white">
      <header className="bg-white border-b border-gray-100 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 pt-4 pb-3">
          ...
          <p className="text-xs text-gray-400 mb-3">Your kitchen memory — family notes, photos, and AI tips for every recipe.</p>
      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-sm mb-6">Open any recipe in MyRecipeVault and tap 🃏 Cards to add it here</p>
