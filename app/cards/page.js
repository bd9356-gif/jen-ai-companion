          ...
          <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button onClick={async () => {
                ...
                alert('Added to MyCooking! ✓')
              }} className="text-xs font-semibold text-orange-600 border border-orange-200 rounded-lg px-3 py-1.5 hover:bg-orange-50">🎯 MyCooking</button>
