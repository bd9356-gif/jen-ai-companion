  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 pb-16">
        {/* Video */}
        {recipe.youtube_url && showVideo && (
          <div className="mb-6">
            <UnifiedVideoPlayer url={recipe.youtube_url} onClose={() => setShowVideo(false)} />
          </div>
        )}
        {recipe.youtube_url && !showVideo && (
          <button onClick={() => setShowVideo(true)}
            className="w-full mb-6 py-4 bg-red-600 text-white rounded-2xl font-semibold text-base flex items-center justify-center gap-2">
