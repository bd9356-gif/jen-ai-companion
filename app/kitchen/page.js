...
const SECTIONS = [
  ...
  },
  {
    ...
    desc: 'Your go-to favorites, always within reach.',
    href: '/saved',
  },
  {
    icon: '🃏',
    title: 'Recipe Cards',
    subtitle: '— Organized & Clean',
    desc: 'Clean, organized recipe cards you can trust.',
    href: '/cards',
  },
  {
    icon: '👨‍🍳',
    title: 'Top Chef AI Recipes',
    subtitle: '— Elevated Dishes',
    desc: 'Elevated dishes crafted by your AI chef.',
    href: '/topchef',
  },
  {
    icon: '📅',
    title: 'Daily / Weekly Recipes',
    subtitle: '— Your Plan',
    desc: 'Fresh ideas for today, plans for your week.',
    href: '/weeklyplan',
  },
  {
    icon: '🔒',
    title: 'Top Secret Recipes',
    subtitle: '— Family Treasures',
    desc: "Your family\'s treasured recipes, kept safe and close.",
    href: '/secret',
  },
  {
    icon: '🤖',
